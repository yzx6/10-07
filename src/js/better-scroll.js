...
! function(t, i) { "object" == typeof exports && "undefined" != typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define(i) : t.BScroll = i() }(this, function() {
    ...
    return st.prototype.onScroll = function() {
        ...
        this.isAnimating = !0, H(this.animateTimer),
            function t() {
                var i = w();
                if (g <= i) return c.isAnimating = !1, c._translate(r, h, m), c.trigger("scroll", { x: c.x, y: c.y }), void(c.pulling || c.resetPosition(c.options.bounceTime) || c.trigger("scrollEnd", { x: c.x, y: c.y }));
                var e = l(i = (i - f) / a),
                    s = (r - p) * e + p,
                    o = (h - d) * e + d,
                    n = (m - u) * e + u;
    ...
    }, ot.prototype._initInfinite = function() { this.options.probeType = 3, this.maxScrollY = -it, this.infiniteScroller = new st(this, this.options.infinity) }, ot.Version = "1.12.4", ot
});